...
# Predefined test citations
PREDEFINED_CITATIONS = {
    "https://www.ijraset.com/research-paper/fire-detection-using-image-processing": {
        "authors": [
            "Tejashri M. Mane", "Dipak Kudke", "Shivkumar Kore",
            "Vikrant Dhongde", "Pratik Kanwade"
        ],
    ...
    "https://pmc.ncbi.nlm.nih.gov/articles/PMC8285156" : {
        "authors" : [
            "Junaid Bajwa", "Usman Munir B", "Aditya Nori", "Bryan Williams" 
            ],
...
def extract_metadata(url):
    ...
    try:
        ...
        citation = Citation()
        citation.url = url
        citation.title = soup.title.string.strip() if soup.title else "[[[TITLE]]]"

        # Author (optional extraction)
        author_meta = soup.find("meta", attrs={"name": "author"})
        citation.authors = [author_meta["content"]] if author_meta else []
